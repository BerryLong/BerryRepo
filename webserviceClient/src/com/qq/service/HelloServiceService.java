 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://test.com/", wsdlLocation = "http://10.7.190.163:1234/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://test.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.7.190.163:1234/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://test.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com/", "HelloServicePort"), HelloService.class, features);
    }
